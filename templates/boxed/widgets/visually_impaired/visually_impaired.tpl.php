<div class="visually_impaired">
	<i class="bx-eye"></i>
	<div class="vi_fonts">
		<a class="fontzoomout" title="Уменьшить шрифт"><i class="bx-minus"></i></a>
